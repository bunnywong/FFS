...
function optimizer_css_js() { 
	if ( !is_admin() ) {
		...
		wp_enqueue_style( 'optimizer-customized', get_template_directory_uri().'/customized.css', 'customized');
		...
		{
		    wp_enqueue_script('elevateZoom',get_template_directory_uri().'/assets/js/jquery.elevateZoom-3.0.8.min.js', array('jquery'), '3.0.8');
		}
	}
}	
