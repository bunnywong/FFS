...
//HEADER NAV
$wp_customize->add_setting( 'optimizer[head_nav_borderbottom_image_url]',array(
    'type' => 'option',
    'default' => '',
    'sanitize_callback' => 'esc_url_raw',
) );

            $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'head_nav_borderbottom_image_url',array(
                    'label'       => __( 'Header Border Bottom', 'optimizer' ),
                    'section'     => 'headheader_section',
                    'settings'    => 'optimizer[head_nav_borderbottom_image_url]',
                    //'description' => __('This image will replace the text logo.','optimizer'),
            ) ) );
            
//HEADER NAV
$wp_customize->add_setting( 'optimizer[head_nav_borderbottom_min_image_url]',array(
        'type' => 'option',
        'default' => '',
        'sanitize_callback' => 'esc_url_raw',
) );

            $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'head_nav_borderbottom_min_image_url',array(
                    'label'       => __( 'Header Border Bottom(Mobile)', 'optimizer' ),
                    'section'     => 'headheader_section',
                    'settings'    => 'optimizer[head_nav_borderbottom_min_image_url]',
                    //'description' => __('This image will replace the text logo.','optimizer'),
            ) ) );
