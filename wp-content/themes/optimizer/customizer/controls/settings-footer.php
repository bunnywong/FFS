...
$wp_customize->add_setting( 'optimizer[footer_background_image_url]',array(
        'type' => 'option',
        'default' => '',
        'sanitize_callback' => 'esc_url_raw',
) );
			
			$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'footer_background_image_url',array(
			        'label'       => __( 'Footer Background Image', 'optimizer' ),
			        'section'     => 'footercolors_section',
			        'settings'    => 'optimizer[footer_background_image_url]',
