...
?>
<li class="acordian-content accordion_head uncompleted checkout_payment_li"><div class="list-heading"><?php echo __("PAYMENT METHOD",'optimizer-child') ?></div>
...
<p class="text-center">
	<input type="button" class="btn-checkout" name="woocommerce_save_payment" id="save_payment" value="<?php echo __("CONTINUE",'optimizer-child'); ?>"/>
</p>
<?php
if ( ! is_ajax() ) {
